...
//                    Convertendo a variável de tempo para poder utilizar o assert do junit
                    String tempo_str = Long.toString(decorridoBubble);
                    int tempo_i = Integer.valueOf(tempo_str).intValue();
                    
//                    o método de validação junit
                    assertEquals(200, tempo_i , 100);
